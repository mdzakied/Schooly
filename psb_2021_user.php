        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-white z-20" id="nav-content">
            <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
                <li class="mr-6 my-2 md:my-0">
                    <a href="psb_2021_user.php" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline border-b-2 border-yellow-500">
                ...
                <table id="example" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-priority="3">Sekolah Asal</th>
                            <th data-priority="4">Sekolah Tujuan</th>
                            <th data-priority="5">Jurusan</th>
                     ...
                     <tbody>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td><?= $user_data['sekolah_asal']; ?></td>
                                <td><?= $user_data['sekolah_tujuan']; ?></td>
